...
int __cdecl _tmain(int argc, TCHAR *argv[])
{
	...
	if (wcslen(argv[1]) > PATH_MAX_LEN*sizeof(TCHAR) - wcslen(ProfileDirectory) - wcslen(L"\\prof_.txt") - 1) {
	...
	_snwprintf_s(path, PATH_MAX_LEN, _TRUNCATE, L"%ls\\%ls\\prof_%ls.txt", crt_dir, ProfileDirectory, argv[1]);
