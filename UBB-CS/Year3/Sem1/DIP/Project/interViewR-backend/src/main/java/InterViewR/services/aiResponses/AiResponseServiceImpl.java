...
public class AiResponseServiceImpl implements AiResponseService {
    private static final String OPENAI_API_ENDPOINT = "";
    private static final String OPENAI_API_KEY = ""; // Replace with your actual API key
    ...
    private List<String> getKeywordsList() {
        return List.of("Adaptable", "Collaborative", "Analytical", "Effective Communicator", "Curious",
                "Detail-Oriented", "Initiative-taker",
                "Backend Development", "Programming Languages", "Database Management", "Problem Solving",
                "Version Control");
    }
    ...
    private List<Map<String, String>> getConversationHistory(Chat chat) {
        ...
        for (int i = 0; i < previous_messages.size(); i++) {
            /// TODO: after profile from above is cut, take into consideration that on
            /// position 0 is the profile and
    ...
    /// TODO: Ce face? face un call la chat gpt cu profilul si cu lista de keywords
    /// si imi spune cuvintele gasite si un procentaj.
    ...
    public EndMessageResponse sendFinalGptMessage(EndChatRequest request) {
        ...
        // String messageToSend = "Stop acting like the given character. Now analyze our
        // conversation. Calculate how many of your given traits did you use in your
        // responses. Answer me like this: \"{number}%\".";
    ...
    public SendMessageResponse sendGptMessage(SendMessageRequest request) {
        ...
        /// TODO: sa apelez creearea de profil si sa o adaug ca prim mesaj in
        /// conversatie
