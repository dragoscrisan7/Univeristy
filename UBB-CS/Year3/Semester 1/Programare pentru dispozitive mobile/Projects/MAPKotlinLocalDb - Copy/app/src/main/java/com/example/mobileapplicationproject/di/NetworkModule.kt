...
object NetworkModule {
    ...
    private const val BASE_URL = "http://192.168.1.222:5000" // Replace with your actual base URL
    ...
    fun provideRetrofit(gson: Gson): Retrofit {
        ...
        interceptor.setLevel(HttpLoggingInterceptor.Level.BASIC)  // Add this line for logging
