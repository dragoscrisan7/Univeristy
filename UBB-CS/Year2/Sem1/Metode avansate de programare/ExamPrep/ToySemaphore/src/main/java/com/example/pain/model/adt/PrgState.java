...
public class PrgState {
    ...
    private MyIToySemaphore toySemaphoreTable;
    MyIDictionary<String, BufferedReader> fileTable;
    private int id;
    private static int lastId = 0;

    public PrgState(MyIStack<IStmt> stk, MyIDictionary<String, Value> symtbl, MyIList<Value>
            out, MyIDictionary<String, BufferedReader> fileTable, MyIToySemaphore toySemaphoreTable, MyIHeap heap){
        this.exeStack=stk;
    ...
    public PrgState(MyIStack<IStmt> stack, MyIDictionary<String,Value> symTable, MyIList<Value> out, MyIDictionary<String, BufferedReader> fileTable, MyIToySemaphore toySemaphoreTable, MyIHeap heap, IStmt program) {
        this.exeStack = stack;
    ...
    public void setToySemaphore(MyIToySemaphore toySemaphoreTable) {
        this.toySemaphoreTable = toySemaphoreTable;
    }
    public MyIToySemaphore getToySemaphore() {
    ...
    public String toySemaphoreToString() throws MyException {
