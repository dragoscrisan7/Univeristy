...
public class PrgState {
    ...
    public PrgState(MyIStack<IStmt> stk, MyIDictionary<String, Value> symtbl, MyIList<Value>
            out, MyIDictionary<String, BufferedReader> fileTable, MyIBarrierTable barrierTable, MyIHeap heap){
        this.exeStack=stk;
    ...
    public PrgState(MyIStack<IStmt> stack, MyIDictionary<String,Value> symTable, MyIList<Value> out, MyIDictionary<String, BufferedReader> fileTable, MyIBarrierTable barrierTable, MyIHeap heap, IStmt program) {
        this.exeStack = stack;
