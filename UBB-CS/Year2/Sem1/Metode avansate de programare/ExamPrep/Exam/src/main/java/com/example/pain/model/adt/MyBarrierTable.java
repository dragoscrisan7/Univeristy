    ...
    public void put(int key, Pair<Integer, List<Integer>> value) throws MyException {
        synchronized (this) {
            if (!barrierTable.containsKey(key)) {
                ...
                throw new MyException(String.format("%d already exists in the barrier table!", key));
            }
        }
    }
    ...
    public Pair<Integer, List<Integer>> get(int key) throws MyException {
        synchronized (this) {
            if (barrierTable.containsKey(key)) {
                ...
                throw new MyException(String.format("%d is not present in the barrier table!", key));
            }
        }
    }
