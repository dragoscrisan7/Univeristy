...
public class RelationalExpression implements IExpression{
    ...
    @Override
    public Value eval(MyIDictionary<String, Value> table) throws ExpressionEvaluationException, ADTException {
        Value value1, value2;
        value1 = this.expression1.eval(table);
        if (value1.getType().equals(new IntType())) {
            value2 = this.expression2.eval(table);
