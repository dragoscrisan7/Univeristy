        ...
        IStmt ex12 = new CompStmt(
                ...
                new CompStmt(
                        ...
                        new CompStmt(
                                ...
                                new CompStmt(
                                        new NewSemaphoreStmt("cnt", new rH(new VarExp("v1")), new ValueExp(new IntValue(1))),
                                        new CompStmt(
                                                new ForkStmt(
                                                        new CompStmt(
                                                                new AcquireStmt("cnt"),
    ...
    private void displayProgram(ActionEvent actionEvent) {
        ...
        if (selectedStatement == null) {
            ...
            try {
                ...
                PrgState prgs = new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyDictionary<>(), new MyToySemaphore(), new MyHeap(), selectedStatement);
