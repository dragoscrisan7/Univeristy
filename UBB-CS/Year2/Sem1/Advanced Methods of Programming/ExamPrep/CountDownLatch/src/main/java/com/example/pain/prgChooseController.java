    ...
    private ObservableList<IStmt> getAllStatements() {
        ...
        IStmt ex10 = new CompStmt(
                ...
                new CompStmt(new VarDeclStmt("v2", new RefType(new IntType())), new CompStmt(
                        ...
                        new VarDeclStmt("cnt", new IntType()), new CompStmt(new NewStmt("v1", new ValueExp(new IntValue(2))),
                        new CompStmt(new NewStmt("v2", new ValueExp(new IntValue(3))),
                        new CompStmt(new NewStmt("v3", new ValueExp(new IntValue(4))),
                        new CompStmt(new newLatchStmt("cnt", new rH(new VarExp("v2"))), new CompStmt(
                        new ForkStmt(
                            new CompStmt(new wH("v1", new ArithExp('*', new rH(new VarExp("v1")), new ValueExp(new IntValue(10)))),
                            new CompStmt(new PrintStmt(new rH(new VarExp("v1"))), new CompStmt(new countDownStmt("cnt"),
                            new ForkStmt(new CompStmt(new wH("v2", new ArithExp('*', new rH(new VarExp("v2")), new ValueExp(new IntValue(10)))),
                                ...
                                new ForkStmt(
                                        new CompStmt(new wH("v3", new ArithExp('*', new rH(new VarExp("v3")), new ValueExp(new IntValue(10)))),
    ...
    private void displayProgram(ActionEvent actionEvent) {
        ...
        if (selectedStatement == null) {
            ...
            try {
                ...
                PrgState prgs = new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyDictionary<>(), new MyLatchTable<>() ,new MyHeap(), selectedStatement);
