...
public class PrgState {
    ...
    public PrgState(MyIStack<IStmt> stk, MyIDictionary<String, Value> symtbl, MyIList<Value>
            out, MyIDictionary<String, BufferedReader> fileTable, MyILatchTable<Integer, Integer> latchTable, MyIHeap heap){
        this.exeStack=stk;
    ...
    public PrgState(MyIStack<IStmt> stack, MyIDictionary<String,Value> symTable, MyIList<Value> out, MyIDictionary<String, BufferedReader> fileTable, MyILatchTable<Integer, Integer> latchTable, MyIHeap heap, IStmt program) {
        this.exeStack = stack;
    ...
    public MyILatchTable<Integer, Integer> getLatchTable(){return this.latchTable;}
    public void setLatchTable(MyILatchTable<Integer, Integer> newLT){this.latchTable = newLT;}
    ...
    public String latchTableToString() throws MyException{
        ...
        for(int key: latchTable.getContent().keySet()) {
